...
def calculator(x, y, op):
    return (x+y if op=='+' else x-y if op=='-' else x*y if op=='*' else x/y if op=='/' else "unknown value") if isinstance(x, (int, float)) and isinstance(y, (int, float)) else "unknown value"