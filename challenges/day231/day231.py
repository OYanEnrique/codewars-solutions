...
def uefa_euro_2016(teams, scores):
    team = teams[0] if scores[0] > scores[1] else teams[1]
    return f"At match {teams[0]} - {teams[1]}, {team} won!" if scores[0] != scores[1] else f"At match {teams[0]} - {teams[1]}, teams played draw."