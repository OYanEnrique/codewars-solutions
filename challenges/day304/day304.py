...
'''
def outed(meet, boss):
    happiness_score=sum([valor if chave != boss else valor*2 for chave, valor in meet.items()])/len(meet)
    return 'Get Out Now!' if happiness_score <= 5 else 'Nice Work Champ!'